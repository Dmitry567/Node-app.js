...
const tourSchema = new mongoose.Schema({
  ...
  difficulty: {
    ...
    enum: {
      ...
      message: 'Difficulty is either: easy, medium, difficult'// enum just for String
    }
  },
  ratingsAverage: {
    type: Number,
    ...
    max: [5, 'Rating must be below 5.0'],// Not just for numbers also for dates
...
// Here we created Model for our Schema
const Tour = mongoose.model('Tour', tourSchema);

module.exports = Tour;


// In Mongoose we have four types of Middleware: Document, Query, Aggregate, Model.